let iconPhone = document.querySelector('.fa-phone-alt'),
    iconEmail = document.querySelector('.fa-envelope'),
    iconWhats = document.querySelector('.fa-whatsapp'),
    iconViber = document.querySelector('.fa-viber');
